...
matplotlib is a plotting library for python which gives you wide variety of plotting methods. matplotlib.org
plt.imshow(src) #
plt.show() #
...
eg. for 5*5 kernel, kernel = np.ones((5, 5), np.float32)/25 #
